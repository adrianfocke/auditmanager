...
export default {
  query: `query personConnection($before: String, $after: String, $first: Float, $last: Float, $sort: String) { personConnection(before: $before after: $after first: $first last: $last sort: $sort filter: {isPartner: {eq: true}}) { edges { node { firstName lastName }}}}`,
